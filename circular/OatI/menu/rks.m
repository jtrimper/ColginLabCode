...
%hedit=uicontrol('Style','edit','String',num2str(Dn),'Position',[175 110 80 20]);
...
%hedit=uicontrol('Style','edit','String',num2str(Dnm),'Position',[175 85 80 20]);
hedit=uicontrol('Style','edit','String',num2str(Dnm),'Position',POSITION(2,:));
set(hedit,'BackgroundColor',[1 1 1]);
ht(hti)=text(0.02,0.2,'Dnp:'); hti=hti+1;
%hedit=uicontrol('Style','edit','String',num2str(Dnp),'Position',[175 60 80 20]);
