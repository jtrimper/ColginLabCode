function [PFCorr,stack1_active,stack2_active] = RM_SpatialCorr_cz_shuffle(stack1,stack2,repetitions,cutoff,nonzero,RC)
% spatial correlation 
...
for i = 1:repetitions
   ...
   [shuffle_mean, shuffle_sem, shuffle_n, shuffle_active,shufflePFCorr,shuffle_stack1_active,shuffle_stack2_active] = CalculatePFCorr_v2(stack1_active,stack2_shuffle,cutoff,nonzero,RC);
   shuffle_active_all=[shuffle_active_all; shuffle_active];
   shuffle=mean(shuffle_active_all);
%    
end
shuffle_mean = mean(shufflePFCorr);

% Output PFCorr
PFCorr = struct('PFCorrActive',PFCorr_active,'PFCorr',PFCorr,'mean',PFCorr_mean,'n',PFCorr_n,'sem',PFCorr_sem,'shuffle_mean',shuffle_mean,'shuffle_PFCorr',shuffle);
