function RateOverlap = RM_RateOverlap_cz(column1,column2,repetitions,cutoff,nonzero,RC2) 
...
[RateRatio_mean, RateRatio_sem, RateRatio_n, RateRatio] = CalculateRatio(column1_nonnan,column2_nonnan,cutoff,nonzero,RC2);
...
for i = 1:repetitions
   ...
   shuffleratio(i) = CalculateRatio(column1_nonnan,column2_shuffle,cutoff,nonzero,RC2);
end
...
function [ratio_mean, ratio_sem, ratio_n, ratio] = CalculateRatio(X,Y,cutoff,nonzero,RC2)
