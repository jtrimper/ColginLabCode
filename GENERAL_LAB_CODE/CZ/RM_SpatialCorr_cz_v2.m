...
%    [shuffle_mean, shuffle_sem, shuffle_n, shuffle_active,shufflePFCorr(:,i),shuffle_stack1_active,shuffle_stack2_active] = CalculatePFCorr_v2(stack1,stack2,cutoff,nonzero,RC);
   shufflePFCorr(i) = CalculatePFCorr_v2(stack1_active,stack2_shuffle,cutoff,nonzero,RC);
end
