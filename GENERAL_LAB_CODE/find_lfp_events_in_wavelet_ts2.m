function evInds = find_lfp_events_in_wavelet_ts2(waveletTs, filtEegData, broadFiltEegData, eegSf, pkThresh, edgeThresh, minDur, plotSwps)
% function evInds = find_lfp_events_in_wavelet_ts2(waveletTs, filtEegData, broadFiltEegData, eegSf, pkThresh, edgeThresh, minDur, plotSwps)
%
% PURPOSE:
...
ampEnv = (waveletTs - nanmean(waveletTs)) ./ nanstd(waveletTs); %z-score, ignoring nans (which come in before/after 1st/last peak)
