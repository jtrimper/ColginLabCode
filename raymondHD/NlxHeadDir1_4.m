...
function NlxHeadDir1_4(inputFile)
...
while ~feof(fid)
    ...
    folder_name = ['HeadDirection_',date,'-out'];
...
%     end
    ...
    drawnow
    pause(0)
    [frontX,frontY] = interporPos(frontX,frontY,param.maxTrackingGap,30);
    [backX,backY] = interporPos(backX,backY,param.maxTrackingGap,30);
