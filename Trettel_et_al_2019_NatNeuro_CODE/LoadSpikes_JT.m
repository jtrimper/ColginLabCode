function S = LoadSpikes_JT(tfilelist, path, NaFile)
...
%
% JBT - got rid of a concatenation that didnt' apply to my purposes
%     - reduced the impact of NaFile because it's just fucking me up
